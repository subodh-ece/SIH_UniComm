...
```mermaid
graph TD
    A[Requirements] --> B[Antenna Design]
    B --> C[HFSS Simulation]
    C --> D[Optimization]
    D --> E[Helmet/CAD Integration]
    E --> F[PCB/RF Design]
    F --> G[Fabrication]
...
## Screenshots 
<img width="1600" height="1128" alt="image" src="https://github.com/user-attachments/assets/c03571cb-3ed1-4a09-b54d-d4b1e03c4bb0" />
